...
public class Ex_04_Thread_class_with_synchronized extends Thread {
	...
	public static void main(String[] args) {
		...
		Ex_04_Thread_class_with_synchronized th1 = new Ex_04_Thread_class_with_synchronized(sharedPrinter,
				engTextStrings);

		Ex_04_Thread_class_with_synchronized th2 = new Ex_04_Thread_class_with_synchronized(sharedPrinter,
				korTextStrings);
